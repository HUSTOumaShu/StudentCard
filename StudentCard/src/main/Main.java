...
//        signature.signPdfFile("sample.pdf", certification.getCertificate(), reason, location);
        apdu.disConnect();
    }
    ...
    public static void generateCSR(APDU apdu, List_of_apdus list_of_apdus) {
        try {
            String subject = "CN=hustshu0,O=SOICT,L=HUST,C=VN";
